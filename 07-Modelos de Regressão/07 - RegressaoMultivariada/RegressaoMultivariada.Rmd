...
onde $ϵ_i∼N(0,σ)ϵi∼N(0,σ$) com$ cov(ϵi,ϵj)=0,∀i≠jcov(ϵi,ϵj)=0,∀i≠j$ e outras premissas usuais (veja na definição geral)
...
Estimativa para $\phi$: é indicada por $\hat\phi$ com valor $0,144$.
...
Para responder à pergunta 2 colocada no início do tópico, envolvendo um possível efeito da elevação ou altitude nos tempos da prova final de $100 m da olimpíada, precisamos utilizar um modelo um pouco mais complexo, envolvendo uma regressão linear múltipla com 2 variáveis explicativas:
