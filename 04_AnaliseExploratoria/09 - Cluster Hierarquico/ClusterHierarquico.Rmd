...
text(x+0.07,y+0.07,labels=as.character(1:12))
```
...
par(mar=rep(0.1,4))
plot(x,y,col="blue",pch=19,cex=2)
points(x[5],y[5],col="orange",pch=3,lwd=3,cex=3)
points(x[2],y[2],col="orange",pch=3,lwd=3,cex=3)
segments(x[5],y[5],x[2],y[2],lwd=3,col="orange")
```
