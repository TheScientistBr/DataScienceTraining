...
**Chi-quadrado**, simbolizado por χ2 é um teste de hipóteses que se destina a encontrar um valor da **dispersão** para duas variáveis nominais, avaliando a associação existente entre variáveis qualitativas. É um teste não paramétrico, ou seja, não depende dos parâmetros populacionais, como média e variância.
