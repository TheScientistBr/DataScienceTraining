...
- Para discutir a distribuição $t$, devemos discutir a distribuição do Qui-quadrado
...
- A distribuição do Qui-quadrado é distorcida e tem suporte em $0$ a $\infty$
- A média do qui-quadrado é seus graus de liberdade
- A variância da distribuição do Qui-quadrado é o dobro dos graus de liberdade

---

## Intervalo de confiança para a variância

Note que se $\chi ^ 2_ {n-1, \alpha}$ é o $\alpha$ quantil da distribuição do qui-quadrado, então
...
- É indexado por um grau de liberdade; Fica mais como um padrão normal como df fica maior
- É obtido como

$$
\frac {Z} {\sqrt {\frac {\chi ^ 2} {df}}}
$$
Onde $Z$ e $\chi^2$ são padrões normais independentes e distribuições de Qui-quadrado, respectivamente
...
Em R, digitar `data(sleep)` traz os dados de sono originalmente
Analisado no documento Biométrika da Gosset, que mostra o aumento da
Horas para 10 pacientes em dois soporific drogas. R trata os dados como dois
Em vez de emparelhados.
