...
- Para uma variável aleatória contínua, $ X $, com densidade, $ f $, o valor esperado
...
- Uma frase anterior buzz no controle de qualidade industrial é "Six Sigma" da Motorola, pelo qual as empresas são sugeridas para controlar eventos extremos ou raras peças defeituosas
- A desigualdade de Chebyshev indica que a probabilidade de um evento "Seis Sigma" é menor que $1/6^2 \approx 3 \%$
- Se uma curva de sino é assumida, a probabilidade de um evento de "seis sigma" é da ordem de $10^{-9}$ (um dez milionésimo de um por cento)
